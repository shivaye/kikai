        ...
        <div class="box">            
          ...
          <div class="row">
            ...
            <div class="col-sm-6" style="text-align: center;">
              <form method="GET" action="/searched-projects">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$project->created_at}}
                    ...
                    <td><img src="/projects-img/{{$project->image_url}}" style="width: 100px; height: 100px"></td>
                    <td>{{$project->status}}</td>
                    <td>
                      <button class="btn btn-primary"><a href="/admin/edit-project/{{$project->id}}" style="color: #fff">EDIT</a></button>
                      <a href="/admin/projects-list/{{ $project->id }}"><input type="submit" name="delete" value="Delete" class="btn btn-danger"></a>
