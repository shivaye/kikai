...
<a href="/admin/projects-list" style="padding: 2%"><button type="submit" class="btn btn-primary" style="padding: 0.5% 3%">Back</button> </a><br><br>
            ...
            <div class="box-header">
              <h3 class="box-title">Enter Project detail Here
            ...
            <div class="box-body pad">
              <form method="POST" action="/admin/add-project-success" enctype="multipart/form-data">
                @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="project_name">Project NAme</label>
                  <input type="text" class="form-control" id="project_name" name="project_name" placeholder="Enter Project Name Here">
                </div>
                ...
                <div class="form-group">
                  <label for="link">URL ( of Project )</label>
                  <input type="text" class="form-control" id="link" name="link" placeholder="Enter Short Description Here">
                </div>

                <div class="form-group">
                  <label for="author">Owner</label>
                  <input type="text" class="form-control" id="author" name="author" placeholder="Enter Short Description Here">
                </div>
