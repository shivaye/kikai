			...
			<div class="col-md-12">
				...
				<div class="box">
					...
					<div class="box-body pad">
						<form method="POST" action="/admin/add-testimonial-success" enctype="multipart/form-data">
							@csrf
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="occupasion" name="occupasion" placeholder="Occupasion">
								</div>

								<div class="form-group">
									<label for="review">Review</label>
									<textarea class="textarea" name="review" placeholder="Place some text here"
									id="review" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
								</div>
